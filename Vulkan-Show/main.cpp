...
static std::vector<char> readFile(const std::string& filename) {
	...
	// Open file in binary mode, seek to the end to get the file size
	std::ifstream f1(filename, std::ios::ate | std::ios::binary);
...
private:
    ...
    void cleanup() {
        ...
        std::cout << "Vulkan Instance is Destroyed" << std::endl;
    ...
    void createInstance() {
        ...
        if (vkCreateInstance(&createInfo, nullptr, &instance) != VK_SUCCESS) {
            ...
            std::cout << "Vulkan Instance is created" << std::endl;
        }
    }
    ...
    void pickPhysicalDevice() {
        ...
        if (physicalDevice == VK_NULL_HANDLE) {
            ...
            std::cout << "Physical Device is created" << std::endl;
        }
    }
    ...
    void createImageViews() {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++) {
            ...
            if (vkCreateImageView(device, &createInfo, nullptr, &swapChainImageViews[i]) != VK_SUCCESS) {
				...
				std::cout << "Image Views is created" << std::endl;
			}
        }
    }
    ...
    void createCommandBuffer() {
		...
		if (vkAllocateCommandBuffers(device, &allocInfo, &commandBuffer) != VK_SUCCESS) {
			...
			std::cout << "Command Buffer is created" << std::endl;
		}
    }
	...
	void createSyncObjects() {
		...
		if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphore) != VK_SUCCESS ||
            ...
            std::cout << "Semaphores are created" << std::endl;
        }
